...
final class AgentRunnerToolingTests: XCTestCase {
    ...
    func testToolExecution_currentTimeProducesContextBlock() async throws {
    ...
    func testToolExecution_webSearchReturnsNoResults() async throws {
        let mock = MockToolService()
    ...
    func testToolExecution_webSearchReturnsErrorOnFailure() async throws {
        let mock = MockToolService()
        mock.webSearchError = NSError(domain: "TestError", code: -1,
    ...
    func testToolExecution_webSearchMissingQueryReturnsValidationError() async throws {
        let mock = MockToolService()
        let service = ToolExecutionService(toolService: mock)
    ...
    func testToolExecution_unknownToolReturnsError() async throws {
        let mock = MockToolService()
        let service = ToolExecutionService(toolService: mock)
